...
// Use a stable reference for DialogPortal
const DialogPortal = React.memo(({ children, ...props }: DialogPrimitive.DialogPortalProps) => (
...
// Simplify DialogOverlay to avoid ref issues
...
// Rewrite DialogContent to avoid nesting issues
